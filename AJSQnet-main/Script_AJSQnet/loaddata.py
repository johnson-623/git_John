...
def LoadDataset_scar(imagenames, labelnames, scarlabelnames):
    ...
    #print('This is loaddata.py')
    #print('prob_norm',gt_dis_normal.shape)
    #print('prob_scar',gt_dis_scar.shape)
...
def save_test_img(nibimage, outputlab):
    ...
    try:
        ...
        print('outputlab.shape=',outputlab.shape)
...
def ProcessTestDataset(imagename, LAlabelname, LAscarMaplabelname, Seg_net):
    ...
    numpyimage, _, _, _, _ = LoadDataset_scar(imagename, LAlabelname, LAscarMaplabelname)
    #print('numpyimage.shape=',numpyimage[0].shape)
    NumSlice=1
    ...
    try:
        ...
        print('nibimage.shape:',nibimage.shape)
        print('label_LA.shape:',label_LA.shape)
